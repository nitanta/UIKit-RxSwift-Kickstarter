//
//  SkeletalImageView.swift
//  TEMPLATEENGINE
//
//  Created by ebpearls on 8/14/19.
...
class SkeletalImage: CircularImage{
    
    var startLocations : [NSNumber] = [-1.0,-0.5, 0.0]
    var endLocations : [NSNumber] = [1.0,1.5, 2.0]
    
    var gradientBackgroundColor : CGColor = UIColor(white: 0.60, alpha: 1.0).cgColor
    var gradientMovingColor : CGColor = UIColor(white: 0.40, alpha: 1.0).cgColor
